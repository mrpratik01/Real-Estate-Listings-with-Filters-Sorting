      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="relative w-full sm:w-[45%]">
          <div className="relative h-full">
            <ImageSlider images={property.image} linkHref={`/properties/${property.id}`} />
            {/* Price Tag */}
  ...
  <div className="flex flex-col h-full space-y-6">
    ...
    <div className="space-y-3">
      ...
      <Link href={`/properties/${property.id}`}>
        <h2 className="text-2xl font-bold text-gray-800 hover:text-blue-600 transition-colors duration-300 line-clamp-2">
          {property.address}
        </h2>
      </Link>
    </div>
    ...
    <div className="mt-auto space-y-4">
      <div className="flex items-center justify-between py-4 border-t border-gray-100">
        <div className="flex items-center gap-3">
          ...
          <div className="space-y-0.5">
            <p className="text-gray-900 font-semibold">{property.agentName}</p>
            <p className="text-blue-600 font-medium">{property.agentContact}</p>
          </div>
        </div>
      ...
      <Link 
        ...
        className="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3.5 rounded-xl transition-all duration-300 font-medium hover:shadow-lg hover:shadow-blue-100"
      >
        View Details
      </Link>
    </div>
